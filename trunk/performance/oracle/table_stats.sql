...
-- added prompts
-- added ability to run against table in another schmema
-- Modified by Thiago Maciel
-- added histogram column information
...
declare
  ...
  select a.column_name, nvl(a.last_analyzed,to_date('01/01/1900','mm/dd/yyyy')) last_analyzed,
         ...
         a.num_buckets, a.avg_col_len, a.sample_size,a.histogram
