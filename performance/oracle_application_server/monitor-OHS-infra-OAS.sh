...
OAS_DIR="/apps/oracle/IAS10gR2/infra"
# Inmetrics home
...
metrics=`${OAS_DIR}/bin/dmstool -l | grep -e request.active -e request.avg -e connection.active -e connection.avg -e numChildren.value -e busyChildren.value -e readyChildren.value`
